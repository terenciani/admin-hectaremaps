<template>
    <div>
        ...
        <local-service-request @list="init" v-else></local-service-request>
        <confirm-dialog
            :show="dialogRedirect"
            :message="`Depois de finalizar você não poderá fazer alterações na solicitação!`"
            @confirm="$router.push('/localrequests')"
...
import LocalServiceRequest from '../components/LocalServiceRequest.vue';
